...
<%@ include file="./jsp/common/html_Head.jsp" %>

<html lang="zh-CN">
	<head>
        <%@ include file="./jsp/common/head_Top.jsp" %>
		<title>【XXXXX】XXXXX</title>
        <%@ include file="./jsp/common/head_Middle.jsp" %>
        <link rel="stylesheet" href="./assets/css/sample.css?v=1.0.0" />
        <style type="text/css"></style>
        <%@ include file="./jsp/common/head_Bottom.jsp" %>
	</head>
    
	<body>

		<s:form id="SampleFormID" method="post" action="./Main/SampleAction.action" theme="simple">
...
test
    ...
    <%@ include file="./jsp/common/html_Bottom.jsp" %>
